...
import { collection, query, where, orderBy, limit, getDocs, updateDoc, doc, setDoc } from 'firebase/firestore';
import { db } from '@/lib/firebase';
import { findMatches } from '@/lib/matching';
import type { MatchResult, Session, SessionProposal } from '@/lib/types';
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] px-4 py-8 sm:px-6 lg:px-8">
      ...
      >
        ...
        async function handleAcceptProposal(proposal: SessionProposal) {
          try {
        ...
        async function handleRejectProposal(proposal: SessionProposal) {
          try {
