...
import { collection, addDoc, doc, getDocs, query, where, setDoc } from 'firebase/firestore';
import { db } from '@/lib/firebase';
    ...
    try {
      ...
      if (!chatId) {
        ...
        await setDoc(convoRef, {
          ...
          participantNames: { [user.uid]: user.displayName || 'You', [profile.uid]: profile.name },
